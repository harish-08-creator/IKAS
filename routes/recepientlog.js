function recepientlog(req,res) {
    const con = require('../connection.js')

    console.log("Recepient log post")
    ...
    <main class="container mt-4">
        ...
        <div>
          <center>
          <h3 style="font-family: Georgia;" class="text-danger"><b>Entered password is incorrect!</b></h3>
          <br>
          <a class="btn btn-danger" style="font-family: Verdana; font-weight: 600;" href="recepientlog" role="button" target="_self">Try again</a>
          </center>
        </div>
        </section>
      </main>
    ...
    <main class="container mt-4">
        ...
        <div>
          <center>
          <h3 style="font-family: Georgia;" class="text-danger"><b>Entered email is incorrect!</b></h3>
          <br>
          <a class="btn btn-danger" style="font-family: Verdana; font-weight: 600;" href="recepientlog" role="button" target="_self">Try again</a>
          </center>
        </div>
