function adminlog(req,res) {
    ...
    <main class="container mt-4">
        ...
        <div>
          <center>
          <h3 style="font-family: Georgia;" class="text-danger"><b>Entered email or password is incorrect!</b></h3>
          <br>
          <a class="btn btn-danger" style="font-family: Verdana; font-weight: 600;" href="adminlog" role="button" target="_self">Try again</a>
          </center>
        </div>
        </section>
      </main>
